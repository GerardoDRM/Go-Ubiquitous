...
public class ForecastAdapter extends RecyclerView.Adapter<com.udacity.gerardo.app.ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    final private com.udacity.gerardo.app.ItemChoiceManager mICM;
