...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback {
    ...
    private final String LOG_TAG = com.udacity.gerardo.app.MainActivity.class.getSimpleName();
    ...
    @Override
    public void onItemSelected(Uri contentUri, com.udacity.gerardo.app.ForecastAdapter.ForecastAdapterViewHolder vh) {
        if (mTwoPane) {
            // In two-pane mode, show the detail view in this activity by
            // adding or replacing the detail fragment using a
            // fragment transaction.
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        // that it is private!
        return getSharedPreferences(com.udacity.gerardo.app.MainActivity.class.getSimpleName(), Context.MODE_PRIVATE);
    }
