...
package com.udacity.gerardo.sunshinewatchface;
...
public final class WatchFaceUtil {
    ...
    /**
     * The {@link DataMap} key for {@link WatchFaceUtil} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link WatchFaceUtil} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link DataMap} key for {@link WatchFaceUtil} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link DataMap} key for {@link WatchFaceUtil} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    /**
     * The path for the {@link DataItem} containing {@link WatchFaceUtil} configuration.
     */
    ...
    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_BACKGROUND_BOTTOM = "#263238";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_BACKGROUND_BOTTOM =
            parseColor(COLOR_NAME_DEFAULT_AND_AMBIENT_BACKGROUND_BOTTOM);
    ...
    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_BACKGROUND_CIRCLE = "#607D8B";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_BACKGROUND_CIRCLE =
            parseColor(COLOR_NAME_DEFAULT_AND_AMBIENT_BACKGROUND_CIRCLE);
